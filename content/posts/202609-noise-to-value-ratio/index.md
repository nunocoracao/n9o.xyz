...
I started noticing the problem when I joined a technology company that used Slack.
...
Those used to be closer together. Writing a thoughtful document took time, so the effort behind it was at least some evidence that it mattered. That filter was never perfect, but it existed. Today, producing something polished can take one prompt. The appearance of effort no longer tells me much about the value underneath it.
