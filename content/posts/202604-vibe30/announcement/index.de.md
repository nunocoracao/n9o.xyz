---
title: "30 Tage Vibe Coding"
description: "Ich habe 30 Projekte mit KI-gestützter Programmierung gebaut. Begleite mich, während ich jeden Tag eines veröffentliche und teile, was funktioniert hat und was nicht."
summary: "Ich habe 30 Projekte mit KI-gestützter Programmierung gebaut. Begleite mich, während ich jeden Tag eines veröffentliche und teile, was funktioniert hat und was nicht."
...
Teil dieser Übung war auch, diese Werkzeuge besser kennenzulernen. Und nachdem ich viel zu viele Stunden damit verbracht habe, KI-Agenten zu beaufsichtigen, Berechtigungsanfragen zu bestätigen und Terminals zu beobachten, habe ich am Ende ein Tool namens [Watchfire](https://watchfire.io) gebaut. Es erlaubt mir, Arbeit in eine Warteschlange zu stellen, zu definieren, was ich will, und wegzugehen. Später zu fertigen Ergebnissen zurückkommen, statt dazusitzen und jede Dateiänderung zu genehmigen. Es ist früh, es ist rau, und es ist sehr viel in Arbeit. Aber es hat diese ganze Challenge neben einem Vollzeitjob und als alleinerziehender Vater erst möglich gemacht. Mehr dazu am Ende der 30 Tage.
...
Ein Hinweis zu den Kosten: Anthropic sponsert mir einen Max 20x Plan wegen meiner Arbeit an [Blowfish](https://blowfish.page), einem Open-Source-Hugo-Theme. Das bedeutet, ich kann bei dieser Challenge Token verbrauchen, ohne mir Sorgen um die Rechnung zu machen. Ich habe das Glück, das zu haben, und ich möchte transparent sein, weil "mach einfach vibe code für 30 Projekte" ein ganz anderes Angebot ist, wenn man pro Token aus eigener Tasche zahlt.
...
- **Soziale Medien:** Folgt mir auf [LinkedIn](https://linkedin.com/in/nunocoracao), [X](https://x.com/nunocoracao), [Threads](https://threads.net/@nunocoracao) und [Bluesky](https://bsky.app/profile/nunocoracao.com) für tägliche Updates. **#30DaysOfVibeCoding**
- **GitHub:** Alle Projekte werden vom [Index-Repository](https://github.com/nunocoracao/30DaysOfVibeCoding) aus verlinkt

Mal sehen, was passiert. Tag 1 startet morgen.

---

*Dies ist Beitrag 0 der Serie [30 Days of Vibe Coding](/series/30-days-of-vibe-coding/).*
