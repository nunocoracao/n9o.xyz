---
title: "30 Giorni di Vibe Coding"
description: "Ho costruito 30 progetti usando la programmazione assistita dall'IA. Seguimi mentre ne pubblico uno al giorno, condividendo cosa ha funzionato e cosa no."
summary: "Ho costruito 30 progetti usando la programmazione assistita dall'IA. Seguimi mentre ne pubblico uno al giorno, condividendo cosa ha funzionato e cosa no."
...
Una nota sui costi: Anthropic mi sta sponsorizzando un piano Max 20x per il mio lavoro su [Blowfish](https://blowfish.page), un tema open-source per Hugo. Questo significa che posso bruciare token in questa sfida senza preoccuparmi del conto. Sono fortunato ad averlo, e voglio essere trasparente perché "fai semplicemente vibe code per 30 progetti" è una proposta molto diversa quando stai pagando per token di tasca tua.
...
- **Social:** Seguimi su [LinkedIn](https://linkedin.com/in/nunocoracao), [X](https://x.com/nunocoracao), [Threads](https://threads.net/@nunocoracao) e [Bluesky](https://bsky.app/profile/nunocoracao.com) per aggiornamenti quotidiani. **#30DaysOfVibeCoding**
- **GitHub:** Tutti i progetti saranno collegati dal [repository indice](https://github.com/nunocoracao/30DaysOfVibeCoding)

Vediamo cosa succede. Il Giorno 1 inizia domani.

---

*Questo è il post 0 della serie [30 Days of Vibe Coding](/series/30-days-of-vibe-coding/).*
