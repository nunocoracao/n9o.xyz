---
title: "30 Dias de Vibe Coding"
description: "Construi 30 projetos usando programacao assistida por IA. Acompanha a jornada enquanto lanço um por dia, partilhando o que funcionou e o que não funcionou."
summary: "Construi 30 projetos usando programacao assistida por IA. Acompanha a jornada enquanto lanço um por dia, partilhando o que funcionou e o que não funcionou."
...
Parte deste exercício também foi para conhecer melhor estas ferramentas. E depois de passar horas a mais a supervisionar agentes de IA, a aceitar pedidos de permissão e a observar terminais, acabei por construir uma ferramenta chamada [Watchfire](https://watchfire.io). Permite-me enfileirar trabalho, definir o que quero e ir embora. Voltar mais tarde para resultados prontos em vez de ficar sentado a aprovar cada alteração de ficheiro. É inicial, é tosco, e ainda está muito em desenvolvimento. Mas é o que tornou todo este desafio possível a par de um emprego a tempo inteiro e de ser pai solteiro. Mais sobre isto no final dos 30 dias.
...
Uma nota sobre custos: a Anthropic está a patrocinar um plano Max 20x para mim por causa do meu trabalho no [Blowfish](https://blowfish.page), um tema open-source para Hugo. Isso significa que posso gastar tokens neste desafio sem me preocupar com a fatura. Tenho a sorte de ter isso, e quero ser transparente porque "faz vibe code de 30 projetos" é uma proposta muito diferente quando estás a pagar por token do teu bolso.
...
- **Redes sociais:** Segue-me no [LinkedIn](https://linkedin.com/in/nunocoracao), [X](https://x.com/nunocoracao), [Threads](https://threads.net/@nunocoracao) e [Bluesky](https://bsky.app/profile/nunocoracao.com) para atualizações diárias. **#30DaysOfVibeCoding**
- **GitHub:** Todos os projetos estarão ligados a partir do [repositório índice](https://github.com/nunocoracao/30DaysOfVibeCoding)

Vamos ver o que acontece. O Dia 1 começa amanhã.

---

*Esta é a publicação 0 da série [30 Days of Vibe Coding](/series/30-days-of-vibe-coding/).*
