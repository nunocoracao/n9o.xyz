...
Watchfireがこれを27タスクに分割した。今までのプロジェクトで最多のタスク数で、納得のいく結果だ。このゲームは互いに連携する必要のあるシステムがたくさんある：戦闘計算、XPカーブ、ドロップテーブル、ペットの挙動、プレステージボーナス、トーナメントブラケット、デイリーチャレンジ、ライバルトラッキング、実績、リプレイ。
