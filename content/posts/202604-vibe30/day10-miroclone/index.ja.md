...
パンとズームができる無限キャンバス、複数の図形ツール、フリーハンド描画、スマートコネクタ、レイヤーシステム、元に戻す／やり直し、エクスポート、ダークモード、プレゼンテーションモード。1日分にしては機能が多すぎる。
...
Miroを置き換えられるか？無理。コラボレーション機能もないし、リアルタイム同期もクラウドストレージもない。でもローカルファーストのスケッチ＆ダイアグラムツールとしては？意外と使える。気づいたら、テストするつもりが実際にアイデアを整理するのに使っていた。
