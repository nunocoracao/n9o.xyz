...
**2015 - Google creates DeepDream - [Read More][9]**
...
There was a story not so long, about a journalist from The Atlantic that used Midjourney to generate images for an article and received massive backlash on Twitter. You can read his thoughts on what happened [here][40]. Given the already difficult and competitive environment some of these artists work in, the potential pushback against these tools is understandable. There is a potential real impact in the job market. Even though it will be bad for some people in the short term, the real question is whether it will be good or bad in the long-run. This phenomenon is quite common in big technological innovations and has happened several times throughout history. 
