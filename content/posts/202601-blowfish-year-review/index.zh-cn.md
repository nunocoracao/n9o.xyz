---
title: "Blowfish 2025：年度回顾"
summary: "回顾 Blowfish 令人难以置信的一年 - 从 16 个版本和无数新功能，到迎来我们的第一位协作者，以及培育一个令人惊叹的贡献者社区。"
description: "回顾 Blowfish 令人难以置信的一年 - 从 16 个版本和无数新功能，到迎来我们的第一位协作者，以及培育一个令人惊叹的贡献者社区。"
...
2025 年最重要的时刻之一是在十月，我迎来了 [@ZhenShuo2021](https://github.com/ZhenShuo2021) 作为 Blowfish 的第一位官方协作者。
...
我见过 Blowfish 被用于个人博客、开发者作品集、文档网站等各种场景。每当有人在 ["Show and Tell"](https://blowfish.page/users/) 区分享他们的网站时，我都会想起为什么要开始这个项目。

## 展望未来

进入 2026 年，我对即将到来的一切感到兴奋。我们建立的基础是坚实的，随着贡献者团队的不断壮大，我们可以将 Blowfish 推向更远。路线图上有新功能、性能改进要做，而且总有更多方法让主题更易于访问和使用。

如果你正在使用 Blowfish，我很想看看你构建了什么。来 [GitHub Discussions](https://github.com/nunocoracao/blowfish/discussions) 分享你的网站。如果你有新功能或改进的想法，请开一个 issue 或加入讨论。
...
*想要支持 Blowfish？考虑[成为赞助者](https://github.com/sponsors/nunocoracao)或为项目做贡献。*
