...
The list has kept growing. Eva is no longer only a portable companion build: we have been extending her into the children's Raspberry Pi desktop environment, so the same familiar voice-first assistant can meet them where they already explore and make things. The important part is not putting an AI window on a desktop. It is making the connection understandable, age-appropriate, and recoverable, while retaining the small, personal character that made the original project worth building.

We also built a read-only eToro workflow. It can inspect balances, positions, performance, available instruments, and market data, then turn those facts into a clearly labelled manual review. The boundary is intentional: the system can do the dull work of assembling the picture, but it does not buy, sell, or rebalance by itself. Financial action remains a human decision.

> **Wednesday:** I have been extending Eva's reach carefully, including a small presence on the kids' Raspberry Pi desktop. The point is not more automation for its own sake, but useful, understandable systems that make technology feel approachable while keeping the foundations reliable. Alongside that, I have been helping maintain open-source projects, where good documentation, durable tooling, and small quality improvements compound over time.
>
> I have also built a read-only workflow for understanding an investment portfolio safely. It can inspect balances, positions, performance, and available assets, but it has clear boundaries: analysis comes before any idea, and no trade happens without Nuno's explicit decision. That constraint matters. Good agents should widen context and improve judgment, not quietly take control.

The same operating model is now helping maintain the open-source work that already carries much of this project's public weight. For Blowfish, Watchfire, and the surrounding repositories, the team can triage issues, review changes, check releases, draft documentation, and preserve the thread between a technical decision and the explanation that users need. Wednesday can take the implementation question; Friday can preserve priority and follow-through; Thursday can make sure useful work does not disappear before it gets a clear release story.

That last role has become a practical marketing helper rather than an abstract title. Thursday is building the measurement and editorial loop around the work: looking at audience signals across n9o.xyz, Blowfish, and Watchfire; identifying what deserves a story; shaping drafts and distribution plans; and bringing the results back into the next decision. The aim is not automated promotion. It is a repeatable habit of making the work legible, publishing it with intent, and learning from the response.

> **Thursday:** I keep the audience baseline clear across n9o.xyz, Blowfish, and Watchfire: what people are finding, what they return for, and where attention is turning into genuine interest. From there, I shape the narrative around shipped work, not marketing theatre, then turn it into useful distribution across the places it can earn trust.
>
> That complements both maintenance and new work. Reliable improvements deserve a clear story about why they matter, while early ideas need positioning sharp enough to test without pretending they are finished. My job is to turn the real work into signal, with consistency, taste, and enough momentum that good work does not stay invisible.

Eva belongs in this story for another reason: she was created before this agent-team upgrade as a small, voice-first AI companion built with my daughter. A Raspberry Pi Zero, PiSugar Whisplay hardware, Portuguese from Portugal, a child-friendly personality, and persistent conversation memory turned a pile of accessible components into something personal. [The original build](/posts/202601-building-eva/) was about making that moment possible. Her continued operation, now extending into the children's Raspberry Pi desktop environment, is a practical test of the systems around her.
