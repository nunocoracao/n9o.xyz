...
Naming note: the classic term is *signal-to-noise ratio* (SNR), borrowed from
electrical engineering, meaning how much of what you receive is the thing you
wanted. "Noise-to-value" is not an established term. Options:
  1. Use "signal-to-noise ratio" and lean on the familiarity.
  2. Keep "noise-to-value" and argue explicitly why value is not the same as
     signal. Signal is what's addressed to you, value is what actually changes
     a decision. That's a real distinction and could be the sharpest idea in
     the post.
Pick one before writing; option 2 is more interesting but has to earn itself.
-->
...
- **Our own agents.** Every agent produces logs, summaries, PRs, notifications, "here's what I did." Run five and you've built yourself a firehose you personally authored.
...
- **The subtle one:** a lot of it isn't wrong or spammy. It's *fine*. Fine is harder to filter than bad.
...
- Measure the ratio, don't just feel it: of everything that reached you today, how much changed a decision?
...
- decide on the naming question above
