...
つい最近まで、DockerでPrincipal Product Managerを務め、AIエージェントを開発者が実際に構築・実行できる実用的なものにすることに注力していました。在任中は、DockerのAIエージェントである[Gordon](https://www.docker.com/products/gordon/)をリリースし、その周辺ツールをオープンソース化しました。エージェントをオーケストレーションする[Docker Agent](https://github.com/docker/cagent)、[MCP Catalog](https://github.com/docker/mcp-registry)、そして[MCP Gateway](https://github.com/docker/mcp-gateway)です。
