...
Até há pouco tempo fui Principal Product Manager na Docker, onde me foquei em tornar os agentes de IA práticos para os programadores construírem e executarem. Aí lancei o [Gordon](https://www.docker.com/products/gordon/), o agente de IA da Docker, e tornei open source as ferramentas à sua volta: o [Docker Agent](https://github.com/docker/cagent) para orquestrar agentes, o [MCP Catalog](https://github.com/docker/mcp-registry) e o [MCP Gateway](https://github.com/docker/mcp-gateway).
