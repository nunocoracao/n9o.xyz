...
不久前，我曾是Docker的首席产品经理，专注于让AI代理真正实用，便于开发者构建和运行。在职期间，我推出了Docker的AI代理[Gordon](https://www.docker.com/products/gordon/)，并将其周边工具开源：用于编排代理的[Docker Agent](https://github.com/docker/cagent)、[MCP Catalog](https://github.com/docker/mcp-registry)以及[MCP Gateway](https://github.com/docker/mcp-gateway)。
