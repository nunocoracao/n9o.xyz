...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Principal Product Manager</td>
            <td>2024 - 2026</td>
            <td>Full Remote </br> Lisbona, PT</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><img class="customEntitityLogo" src="/resume/aws.png"/></td>
            <td><a href="https://aws-startup-lofts.com/emea" target="_blank">AWS Startup Loft</a></td>
            <td>Consulente Startup</td>
            <td>2022 - 2024</td>
            <td>Full Remote </br> Lisbona, PT</td>
        </tr>
        <tr>
            <td rowspan=3><img class="customEntitityLogo" src="/resume/truphone.png"/></td>
            <td rowspan=3><a href="https://www.truphone.com/" target="_blank">Truphone</a></td>
        </tr>
        <tr>
            <td>Group Product Manager</td>
            <td>2021 - 2022</td>
            <td rowspan=2>Ibrido </br> Lisbona, PT</td>
        </tr>
        <tr>
        ...
        <tr>
            <td rowspan=3><img class="customEntitityLogo" src="/resume/vodafone.png"/></td>
            <td rowspan=3><a href="https://www.vodafone.com/" target="_blank">Vodafone Group</a></td>
        </tr>
        <tr>
            <td>Analytics Squad Lead</td>
            <td>2019 - 2020</td>
            <td rowspan=2>Lisbona, PT </br> Londra, UK</td>
        </tr>
        <tr>
            <td>Senior Product Manager</td>
            <td>2018 - 2019</td>
        ...
        <tr>
            <td><img class="customEntitityLogo" src="/resume/sky.png"/></td>
        ...
        <tr>
            <td><img class="customEntitityLogo" src="/resume/skimic.png"/></td>
        ...
        <tr>
            <td><img class="customEntitityLogo" src="/resume/vodafone.png"/></td>
            <td><a href="https://www.vodafone.com/" target="_blank">Vodafone Group</a></td>
            <td>Product Manager</td>
            <td>2015 - 2016</td>
            <td>Lisbona, PT</br>Londra, UK</td>
        </tr>
         <tr>
            <td rowspan=3><img class="customEntitityLogo" src="/resume/nos.png"/></td>
            <td rowspan=3><a href="https://www.nos.pt" target="_blank">NOS</a></td>
        </tr>
         <tr>
            <td>Product Manager</td>
            <td>2014 - 2015</td>
            <td rowspan=2>Lisbona, PT</td>
        </tr>
         <tr>
         ...
         <tr>
            <td><img class="customEntitityLogo" src="/resume/inesc.png"/></td>
            <td><a href="https://www.inesc-id.pt/" target="_blank">Inesc-ID</a></td>
            <td>Ricercatore Junior</td>
            <td>2011 - 2012</td>
            <td>Lisbona, PT</td>
        </tr>
    </tbody>
...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan=4><img class="customEntitityLogo" src="/resume/hbs.svg"/></td>
        ...
        <tr>
            <td rowspan=3><img class="customEntitityLogo" src="/resume/ist.png"/></td>
            <td rowspan=3><a href="https://tecnico.ulisboa.pt/en/" target="_blank">Tecnico Lisboa</a></td>
        </tr>
        <tr>
            <td>Laurea Magistrale in Informatica - Sistemi Distribuiti</td>
            <td>2012</td>
        </tr>
        <tr>
            <td>Laurea Triennale in Informatica</td>
            <td>2010</td>
        </tr>
    </tbody>
</table>
